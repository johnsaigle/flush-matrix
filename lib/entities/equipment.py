class Equipment:
    def __init__(self, name, area, residual_volume, cycle_size, flush_material, initial_fill_size=None):
        ...
        self.residual_volume = residual_volume
        self.cycle_size = cycle_size # typical flush size to clean a container. This is a default value to be multipled as determined by the flush_matrix script
        self.flush_material = flush_material # the product used in the flushing
        self.initial_fill_size = initial_fill_size
